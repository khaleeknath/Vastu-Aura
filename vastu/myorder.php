...
<head>
  ...
  <title>My Orders | Vastu Shakti Rahasya</title>
...
<nav class="navbar navbar-expand-xl fixed-top bespoke-navbar" id="siteNavbar">
  ...
  <main>
    ...
    <section class="account-editorial-hero position-relative section-padding pb-0">
      <div class="container mt-5 pt-4 text-center z-index-2 reveal-up">
        ...
        <h1 class="cinzel-heading display-3 mb-4 text-dark-900">Order History</h1>
        <div class="ornate-divider mx-auto mb-5"></div>
      </div>
    </section>

    <!-- Orders Feed -->
    <section class="orders-interface section-padding pt-0">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-10">
            
            <!-- JS Inject Container -->
            <div id="ordersContainer" class="d-flex flex-column gap-4">
               <!-- Loading State -->
               <div class="text-center py-5 reveal-up">
                  <div class="spinner-border text-gold" role="status"></div>
                  <p class="font-montserrat text-muted mt-3">Retrieving your sacred artifacts...</p>
               </div>
            </div>
  ...
  <footer class="bespoke-footer border-top mt-5">
    ...
    <!-- Order Details Modal -->
<div class="modal fade luxury-modal" id="orderDetailsModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content bg-dark-900 border-gold rounded-0">
      <div class="modal-header border-0 py-4 px-4 px-md-5 d-flex justify-content-between align-items-center">
        <h4 class="modal-title cinzel-heading text-gold mb-0">Order Details</h4>
      ...
      <div class="modal-body p-4 p-md-5 pt-0">
        ...
        <div id="orderDetailsLoading" class="text-center py-5">
          <div class="spinner-border text-gold" role="status"></div>
          <p class="font-montserrat text-white-75 mt-3 mb-0">Retrieving order details...</p>
        </div>

        <!-- Content (hidden until loaded) -->
        <div id="orderDetailsContent" class="d-none">
          <p class="font-montserrat text-white-75 mb-4 border-bottom border-light pb-4">
            Full breakdown of items and payment for this order.
          </p>
          ...
          <div class="table-responsive mb-4">
            <table class="table table-borderless luxury-confirm-table w-100 mb-0 font-montserrat text-white">
              <tbody>
                <tr>
                  <th class="text-white-50 text-uppercase small tracking-wide" style="width: 40%;">Order No.</th>
                  <td id="detailOrderId" class="text-end"></td>
                </tr>
                <tr>
                  <th class="text-white-50 text-uppercase small tracking-wide">Order Date</th>
                  <td id="detailOrderDate" class="text-end"></td>
                </tr>
                <tr>
                  <th class="text-white-50 text-uppercase small tracking-wide">Order Status</th>
                  <td id="detailOrderStatus" class="text-end text-gold"></td>
                </tr>
                <tr>
                  <th class="text-white-50 text-uppercase small tracking-wide">Payment Method</th>
                  <td id="detailPaymentMethod" class="text-end"></td>
                </tr>
                <tr>
                  <th class="text-white-50 text-uppercase small tracking-wide">Payment Status</th>
                  <td id="detailPaymentStatus" class="text-end"></td>
                </tr>
                <tr>
                  <th class="text-white-50 text-uppercase small tracking-wide">Transaction ID</th>
                  <td id="detailTransactionId" class="text-end"></td>
                </tr>
              </tbody>
            </table>
          </div>

          <h6 class="text-gold text-uppercase small tracking-wide mb-3 font-montserrat">Items Purchased</h6>
          <div class="table-responsive mb-4">
            <table class="table table-borderless luxury-confirm-table w-100 mb-0 font-montserrat text-white">
              <thead>
                <tr class="border-bottom border-light">
                  <th class="text-white-50 text-uppercase small tracking-wide">Product</th>
                  <th class="text-white-50 text-uppercase small tracking-wide text-center">Qty</th>
                  <th class="text-white-50 text-uppercase small tracking-wide text-end">Price</th>
                  <th class="text-white-50 text-uppercase small tracking-wide text-end">Subtotal</th>
                </tr>
              </thead>
          ...
          <div class="d-flex justify-content-between align-items-center border-top border-light pt-4">
            <span class="text-white-50 text-uppercase small tracking-wide font-montserrat">Total Amount</span>
            <span id="detailTotalAmount" class="fs-4 fw-bold text-gold font-montserrat"></span>
          </div>
        </div>

        <!-- Error state -->
        <div id="orderDetailsError" class="d-none text-center py-4 text-danger font-montserrat"></div>
