document.addEventListener("DOMContentLoaded", () => {
  ...
  if (openModalBtn && form) {
    openModalBtn.addEventListener("click", function () {
      ...
      // FIX: Use getOrCreateInstance instead of instantiating new duplicates on every click
  ...
  //   ? bootstrap.Modal.getOrCreateInstance(emailChangeModalEl)
  //   : null;
      ...
      fetch("assets/api/create-order.php", {
        ...
        .then((orderRes) => {
          ...
          const options = {
            ...
            //     .then((data) => {
            //       if (data.status) {
            //         const confirmInst = bootstrap.Modal.getInstance(
            //           document.getElementById("confirmBookingModal"),
            //         );
            ...
            handler: function (rzpResponse) {
              ...
              // Payment succeeded — hide the confirm modal and show a
              // "processing" state immediately, so the screen is never blank
              // while we save the booking.
              const confirmInst = bootstrap.Modal.getInstance(
                document.getElementById("confirmBookingModal"),
              );
              if (confirmInst) confirmInst.hide();

              const processingModal = bootstrap.Modal.getOrCreateInstance(
